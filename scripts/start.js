...
function setupCompiler(host, port, protocol) {
  ...
  compiler.plugin('done', function(stats) {
    ...
    var showInstructions = !messages.errors.length && isInteractive && isFirstCompile

    if (isSuccessful) {
      console.log(chalk.green('Compiled successfully!'))
    }

    child.exec('cp -r ./build/bot ./public/')
    ...
    if (showInstructions) {
      ...
      if (devCliMessages.stderr) {
        console.log(chalk.red(messagesSeparator))
        console.log(chalk.red(devCliMessages.stderr))
        console.log(devCliMessages.stdout)
        console.log(chalk.red(messagesSeparator))
      } else {
        console.log(chalk.green(messagesSeparator))
        console.log(chalk.green('DApp has been added to Status.'))
        console.log(chalk.green(messagesSeparator))
      }
      console.log()
